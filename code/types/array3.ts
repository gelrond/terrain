...
export class Array3<_TType extends IEquality<_TType>> {
    ...
    public get(x: number, y: number, z: number): _TType {
        ...
        const result = this.getInternal(round(x), round(y), round(z));
    ...
    // returns:     the value
    // ****************************************************************************************************************
    private getInternal(x: number, y: number, z: number): _TType {
    ...
    public set(x: number, y: number, z: number, value: _TType): void {
        ...
        this.setInternal(round(x), round(y), round(z), value);
    }
    ...
    // returns:     n/a
    // ****************************************************************************************************************
    private setInternal(x: number, y: number, z: number, value: _TType): void {
